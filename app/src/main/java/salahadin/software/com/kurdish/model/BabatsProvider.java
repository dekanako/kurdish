...
public class BabatsProvider
{
    ...
    public void initBabatakan(Context context)
    {
        ...
        babats.add(new Babat("منداڵی ژیر",
                "من منداڵێکی ژیرم،قوتابییەکی پاک و زیرەکم. به‌یانیان زوو لە خەو هەڵدەستم. ڕۆژباش لە ئەندامی خێزانەکەم دەکەم. بە ئاو و سابون دەست و دەم و چاوم دەشۆم. بە هێمنی نانی بەیانی دەخۆم، ئەوجا جلەکانم دەگۆڕم و جانتاکەم لە شان دەکەم و بەرەو قوتابخانە دەڕۆم. بە بێدەنگی لە پۆل دادەنیشم و گوێ لە مامۆستاکانم دەگرم"
        ...
        babats.add(new Babat(
                "مۆسیقا",
                "مۆسیقا ئەو دەنگ و ئاوازە خۆشانەیە، کە لەگەڵ گۆرانی و شایی و هەڵپەڕکێ و بۆنه‌کان لێ دەدرێت، لە ئامێرەکانی مۆسیقاوە دەردەچێت و هەستی مرۆڤ دەجووڵێنێ، خۆشی و شادی دەخاتە دلی مرۆڤەوە و بەختیار و دڵخۆشی دەکات"
